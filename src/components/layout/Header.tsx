...
export function Header() {
  ...
  return (
        <header
              ...
              >
          {/* Subtle green botanical top-stripe */}
              <div
                ...
                {/* Logo + Nav */}
                      <div className="flex items-center gap-8">
                                <div
                                            ...
                                            >
                                  {/* Logo mark with a leaf-green ring on hover */}
                                            ...
                                            <div>
                                                          <h1 className="text-xl font-bold tracking-tight">PassAI</h1>h1>
                                              {/* Tiny botanical tagline visible on hover */}
