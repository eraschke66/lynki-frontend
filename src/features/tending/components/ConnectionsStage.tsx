  ...
  return (
    <div className="max-w-2xl mx-auto w-full">
      <div className="text-center mb-5">
        ...
        {isTouch && !allMatched && (
          <p className="text-xs text-ghibli-moss/60 mt-1">
      ...
      <ParchmentCard className="p-5 md:p-6" hover={false}>
        <div className="grid grid-cols-2 gap-3 md:gap-4">
          <div className="flex flex-col gap-2">
            <p className="text-xs uppercase tracking-wider text-ghibli-moss/70 font-medium pb-1 border-b border-ghibli-moss/15">
              {leftHeader}
            </p>
            {pairs.map((p) => {
              ...
              return (
                <div
                  ...
                  className={[
                    ...
                    isMatched
                      ? "bg-ghibli-moss/10 border-ghibli-moss/40 text-ghibli-canopy/70 line-through cursor-default"
              ...
              return (
                <div
                  ...
                  className={[
                    "rounded-md border p-3 text-sm font-sans transition-all select-none",
                    isMatched
                      ? "bg-ghibli-moss/10 border-ghibli-moss/40 text-ghibli-canopy/70 cursor-default"
      ...
      {!showContinue && stuck && (
        <p className="text-xs text-ghibli-moss/70 text-center mt-4">
